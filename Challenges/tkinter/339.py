...
def update_label():
    ...
    lbl1.config(font=fnt)  # or lbl1['font'] = fnt
...
# Method 1;
# lbl1 = Label(win, text="Hello World!", font=("Arial", 40))
# lbl1.grid(row=0, column=0, columnspan=3)

# cbtn1 = Checkbutton(win, text="Bold", font=("Arial", 20), command=lambda: lbl1.config(font=("Arial", 40, "bold")))
# cbtn1.grid(row=1, column=0)

# cbtn2 = Checkbutton(win, text="Italic", font=("Arial", 20), command=lambda: lbl1.config(font=("Arial", 40, "italic")))
# cbtn2.grid(row=1, column=1)

# cbtn3 = Checkbutton(win, text="Underline", font=("Arial", 20), command=lambda: lbl1.config(font=("Arial", 40, "underline")))
# cbtn3.grid(row=1, column=2)



# Method 2;
lbl1 = Label(win, text="Hello World!", font=("Times new Roman", 40))
lbl1.grid(row=0, column=0, columnspan=3)
